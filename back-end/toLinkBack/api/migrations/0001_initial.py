# Generated by Django 5.0 on 2024-09-06 09:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(blank=True, db_column='Media_ID', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.convomedia')),
                ('user', models.ForeignKey(db_column='User_ID', on_delete=django.db.models.deletion.CASCADE, to='api.profile')),
            ],
        ),
        migrations.AddField(
